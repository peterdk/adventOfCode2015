...
# puts SantaString.new(input).three_vowels
# puts SantaString.new(input).double_letter
# puts SantaString.new(input).no_wrong_strings
# puts SantaString.new(input).nice
